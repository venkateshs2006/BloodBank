...
<div id="templatemo_wrapper">
    ...
    <div id="templatemo_main">
        ...
        <div id="templatemo_content">
            ...
            <form:form method="Post" action="bloodrequestform.html"
	commandName="bloodrequest">
	<table>
		<tr>
			<td>Requester Name :<FONT color="red"><form:errors
				path="requesterName" /></FONT></td>
		</tr>
		<tr>
			<td><form:input path="requesterName" /></td>
		</tr>
		...
		<tr>
			<td>Street :<FONT color="red"><form:errors
				path="street" /></FONT></td>
		</tr>
		<tr>
		...
		<tr>
         ...
         <tr>
			<td>Hospital Name :<FONT color="red"><form:errors
				path="hospitalName" /></FONT></td>
		</tr>
		<tr>
			<td><form:input path="hospitalName" /></td>
		</tr>
         <tr>
			<td>Doctor Name :<FONT color="red"><form:errors
		...
		<tr>
			<td><form:input path="doctorName" /></td>
		         ...
		         <tr>
			<td>Doctor Number :<FONT color="red"><form:errors
				path="doctorNumber" /></FONT></td>
		</tr>
		<tr>
			<td><form:input path="doctorNumber" /></td>
		</tr>
		<tr>
			<td>Required Blood Group:<FONT color="red"><form:errors path="bloodGroup" /></FONT></td>
		</tr>
		<tr>
