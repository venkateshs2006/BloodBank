...
<h3>Thanks for your request. Your details has been updated successfully. </h3>
<table>
	<tr>
		<td>Requester Name :</td>
		<td><core:out value="${bloodrequest.requesterName}" /></td>
	</tr>
	<tr>
		<td>BloodGroup :</td>
		<td><core:out value="${bloodrequest.bloodGroup}" /> details has been added successfully.</td>
	</tr>
</table>
				          </div>
