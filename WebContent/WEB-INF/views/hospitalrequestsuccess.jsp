...
<h3>Welcome <core:out value="${hospitalrequest.hospitalName}" />, </h3>
<table>
	<tr>
		<td>Doctor Name :</td>
		<td><core:out value="${hospitalrequest.doctorName}" /></td>
	</tr>
	<tr>
		<td>Hospital Name :</td>
		<td><core:out value="${hospitalrequest.hospitalName}" /> details has been added successfully.</td>
	</tr>
</table>
